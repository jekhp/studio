...
const acomayoFestivals: Festival[] = [
    {
      ...
      province: 'Acomayo',
      coords: [-13.919, -71.684],
      image: 'mollomarka-carnival',
      isFree: true,
      categories: ['carnaval', 'andino', 'danza', 'popular'],
      traditionKeys: ["tradition_1", "tradition_2", "tradition_3", "tradition_4"],
      scheduleKeys: [{ dayKey: 'day_1', eventKeys: [{ timeKey: 'event_1_time', descriptionKey: 'event_1_desc' }] }],
    }
];
...
const antaFestivals: Festival[] = [
    {
      id: 'anta-festival',
      slug: 'anta-festival',
      name: 'Aniversario de Anta',
      date: { start: new Date(currentYear, 10, 18), end: new Date(currentYear, 10, 18) },
      location: 'Anta',
      province: 'Anta',
      coords: [-13.46, -72.15],
      image: 'anta-festival',
      isFree: true,
      categories: ['popular', 'danza', 'conciertos'],
    }
];
...
const paruroFestivals: Festival[] = [
    {
      id: 'paruro-bullfight',
      slug: 'paruro-bullfight',
      name: 'Fiesta Patronal de Paruro',
      date: { start: new Date(currentYear, 9, 8), end: new Date(currentYear, 9, 8) },
      location: 'Paruro',
      province: 'Paruro',
      coords: [-13.76, -71.85],
